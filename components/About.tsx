...
import { ABOUT_IMAGE_FALLBACK, ABOUT_IMAGES } from '@/constants/images';

const About: React.FC = () => {
  // State for images
  const [aboutImages, setAboutImages] = useState([...ABOUT_IMAGES]);
    ...
    <div className={`relative group overflow-hidden shadow-lg border-[3px] md:border-[6px] border-white transition-all duration-500 hover:z-20 hover:scale-105 hover:shadow-2xl ${className}`}>
        <img 
            ...
            onError={(e) => {
              ...
              e.currentTarget.src = ABOUT_IMAGE_FALLBACK;
            }}
        />
    </div>
  );
